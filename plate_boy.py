...
def get_arrangement(target, percent):
    ...
    print(str(percent) + "% of target", str(target), "lbs =", str(adj_target),
    ...
    if remainder > 0:
        print("\n(Arrangement is ", str(remainder), "lbs ("+str("{0:.1f}".format(remainder/adj_target*100)) +"%) short of intended weight.)")
    print(dashes)
